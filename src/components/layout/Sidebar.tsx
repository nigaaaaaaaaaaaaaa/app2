...
import { Boxes, LogOut, ChevronLeft, ChevronRight } from 'lucide-react';
    ...
    >
      ...
      <div className="border-t border-border-subtle p-2">
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={signOut}
            className="p-1.5 rounded-md text-gray-500 hover:text-red-400 hover:bg-bg-tertiary transition-colors"
            title="Sign out"
          >
